...
<!DOCTYPE html>
<html lang="esS" xmlns:th="http://www.thymeleaf.org">
<head>
    <meta charset="UTF-8">
...
<div class="container" style="margin-top: 4%"><h4>CRUD Jefes</h4></div>
        ...
        <div class="modal-dialog" style="width: 60%">
            ...
            <div class="modal-content">
                <div class="modal-header" style="padding: 35px 50px">
                    ...
                    <h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de jefe de prestamista</h4>
                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps"
                                                               href="#stepOne">Datos del Jefe</a></h4>
                                </div>
                                <div id="stepOne" class="panel-collapse collapse in">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" id="id_reg_nombres" name="nombre"
                                                       placeholder="Ingrese el nombre" type="text" maxlength="20"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label"
                                                   for="id_reg_apellido">Apellidos</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" id="id_reg_apellido" name="apellido"
                                                       placeholder="Ingrese el apellido" type="text" maxlength="20"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label" for="id_reg_dni">DNI</label>
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_reg_dni" name="dni"
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label"
                                                   for="id_reg_password">Contraseña</label>
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_reg_password"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_reg_correo" name="email"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_reg_celular"
                                                       name="celular" onkeypress="return soloNumeros(event)"
                                                       placeholder="Ingrese su Celular" maxlength="9"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" id="id_act_usureg" name="usureg"
                                                   value=${sessionScope.objUsuario.idUsuario}></div>

                                        <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="button" class="btn btn-primary" id="id_btn_registra">
                                                    REGISTRA
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <form id="id_form_actualiza" accept-charset="UTF-8" class="form-horizontal" method="post">
                        <div class="panel-group" id="stepsA">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps"
                                                               href="#stepOne">Datos de Tesis</a></h4>
                                </div>
                                <div id="stepOneA" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-3">
                                                <input class="form-control" type="hidden" id="id_act_idA"
                                                       name="idUsuario" maxlength="8"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label" for="id_act_nombresA">Nombres</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" id="id_act_nombresA" name="nombre"
                                                       placeholder="Ingrese el nombre" type="text" maxlength="20"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label"
                                                   for="id_act_apellidoA">Apellidos</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" id="id_act_apellidoA" name="apellido"
                                                       placeholder="Ingrese el apellido" type="text" maxlength="20"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_act_dniA" name="dni"
                                                       onkeypress="return soloNumeros(event)"
                                                       placeholder="Ingrese su DNI" maxlength="8" readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label"
                                                   for="id_act_passwordA">Contraseña</label>
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_act_passwordA"
                                                       name="password" placeholder="Ingrese su Contraseña"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_act_correoA" name="email"
                                                       placeholder="Ingrese su correo"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input class="form-control" type="text" id="id_act_celularA"
                                                       name="celular" onkeypress="return soloNumeros(event)"
                                                       placeholder="Ingrese su Celular" maxlength="9"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" id="id_reg_usureg" name="usureg"
                                                   value=${sessionScope.objUsuario.idUsuario}></div>


                                        <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="button" class="btn btn-primary" id="id_btn_actualiza">
                                                    ACTUALIZAR
                                                </button>
                                            </div>
                                        </div>
